...
| 1.2 | Добавить `docs/` и путь к некатегорийному файлу | `project_config.yaml` | ✅ Выполнено |
| 1.3 | Вынести все group_cols в конфиг (двух видов) | `project_config.yaml` | ✅ Выполнено |
| 1.4 | Добавить настройку выбора целевого столбца | `project_config.yaml` | ✅ Выполнено |
| 1.5 | Добавить флаг `remove_zeros` и `remove_empty` | `project_config.yaml` | ✅ Выполнено |
| 1.6 | Обновить структуру путей под `route_1/`, `route_2/` | `project_config.yaml` | ✅ Выполнено |
| 1.7 | Добавить режимы `route_1`, `route_2`, `both` | `project_config.yaml` | ✅ Выполнено |
...
| № | Задача | Файл | Статус |
|---|--------|------|--------|
| 6.1 | Создать `docs/example_config.yaml` с полным примером | `docs/example_config.yaml` | ✅ Выполнено |
...
| ✅ Режимы работы | `mode: with_categories` / `without_categories` | Этап 4 |
...
| ✅ Автоматизация | `python main_final_v3.py` → дашборд | Этап 4 |
